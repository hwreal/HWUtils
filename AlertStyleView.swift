...
public protocol AlertStyleView {}
...
extension AlertStyleView where Self: UIView{
...
fileprivate extension UIView{
    @objc func tapOverlayView(_ tap: UITapGestureRecognizer){
        guard let selfView = self as? AlertStyleView & UIView else {return}
